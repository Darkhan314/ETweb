window.onload = function () {
    ...
    function showResult() {
        ...
        // let imt = document.createElement('imt');
        // imt.innerHTML = w.value / (eh * eh);
        // if (imt.value > 0) {
        //     document.querySelector('main').appendChild(imt) + "ИМТ ниже 18.5  - свидетельствует о недостаточном весе";
        //}
    }
